...
import { LockBox, LockBox__factory, TestERC1155, TestERC1155__factory, TestNFT, TestNFT__factory, TestToken, TestToken__factory } from "../typechain";
...
let lockBox: LockBox, testToken: TestToken, testToken2: TestToken, testNFT: TestNFT, testNFT2: TestNFT, testERC1155: TestERC1155;
...
describe('LockBox Test Stack', () => {
  ...
  beforeEach(async () => {
    ...
    const TestERC1155: TestERC1155__factory = await ethers.getContractFactory('TestERC1155')
  ...
  describe("Trade ERC20", async () => {
    ...
    describe("Trade ERC20 Tokens for an ERC1155 Token ", async () => {
      ...
      it("A user can create a lockbox by paying fee ", async () => {
        ...
        await lockBox.connect(user1).createLockBox(
          AssetType.TOKEN, testToken.address, 0, ethers.utils.parseEther("100"),
          AssetType.ERC1155, testERC1155.address, 1, 1,
          OneDayduration,
          { value: ethers.utils.parseEther("0.1") }
        )
      ...
      it("Both users can lock their assets ", async () => {
        ...
        await testERC1155.connect(user2).mint(1, 1);
        await testERC1155.connect(user2).setApprovalForAll(lockBox.address, true)
        await lockBox.connect(user2).lockAsset(1);
        ...
        expect(await testToken.balanceOf(user1.address)).to.equal(ethers.utils.parseEther("0"));
        expect(await testToken.balanceOf(user2.address)).to.equal(ethers.utils.parseEther("0"));
        expect(await testToken.balanceOf(lockBox.address)).to.equal(ethers.utils.parseEther("100"));

        expect(await testERC1155.balanceOf(user1.address, 1)).to.equal(0);
        expect(await testERC1155.balanceOf(user2.address, 1)).to.equal(0);
        expect(await testERC1155.balanceOf(lockBox.address, 1)).to.equal(1);
      ...
      it(" Both users can claim their assets ", async () => {
        ...
        expect(await testToken.balanceOf(user1.address)).to.equal(ethers.utils.parseEther("0"));
        expect(await testToken.balanceOf(user2.address)).to.equal(ethers.utils.parseEther("100"));
        expect(await testToken.balanceOf(lockBox.address)).to.equal(ethers.utils.parseEther("0"));

        expect(await testERC1155.balanceOf(user1.address, 1)).to.equal(1);
        expect(await testERC1155.balanceOf(user2.address, 1)).to.equal(0);
        expect(await testERC1155.balanceOf(lockBox.address, 1)).to.equal(0);
  ...
  describe("Trade NFT ", async () => {
    ...
    describe("Trade NFT for an ERC1155 Token ", async () => {
      ...
      it("A user can create a lockbox by paying fee ", async () => {
        ...
        await lockBox.connect(user1).createLockBox(
          AssetType.NFT, testNFT.address, 0, 1,
          AssetType.ERC1155, testERC1155.address, 11, 1,
          OneDayduration,
          { value: ethers.utils.parseEther("0.1") }
        )
      ...
      it("Both users can lock their assets ", async () => {
        ...
        expect(await testNFT.balanceOf(lockBox.address)).to.equal(1);
      ...
      it("Both users can claim their assets ", async () => {
        ...
        expect(await testNFT.balanceOf(lockBox.address)).to.equal(0);
  ...
  describe("Trade ERC1155 ", async () => {

    describe("Trade 1155 token for a ETHs ", async () => {
      ...
      it("Both users can lock their assets ", async () => {
        ...
        await testERC1155.connect(user1).mint(1, 1);
        await testERC1155.connect(user1).setApprovalForAll(lockBox.address, true)
        await lockBox.connect(user1).lockAsset(1);
      ...
      it("Both users can claim their assets ", async () => {
        ...
        expect(await testERC1155.balanceOf(user1.address, 1)).to.equal(0);
        expect(await testERC1155.balanceOf(user2.address, 1)).to.equal(1);
        expect(await testERC1155.balanceOf(lockBox.address, 1)).to.equal(0);
    ...
    describe("Trade 1155 token for a Token ", async () => {
      ...
      it("A user can create a lockbox by paying fee ", async () => {
        ...
        await lockBox.connect(user1).createLockBox(
          AssetType.ERC1155, testERC1155.address, 1, 1,
          AssetType.TOKEN, testToken.address, 0, web3.utils.toWei('1', 'ether'),
          OneDayduration,
          { value: ethers.utils.parseEther("0.1") }
        )
      ...
      it("Both users can lock their assets ", async () => {
        ...
        await lockBox.connect(user1).createLockBox(
          AssetType.ERC1155, testERC1155.address, 1, 1,
          AssetType.TOKEN, testToken.address, 0, web3.utils.toWei('100', 'ether'),
          OneDayduration,
          { value: ethers.utils.parseEther("0.1") }
        )
      ...
      it("Both users can claim their assets ", async () => {
        ...
        expect(await testToken.balanceOf(user1.address)).to.equal(ethers.utils.parseEther("100"));
        expect(await testToken.balanceOf(user2.address)).to.equal(0);
        expect(await testToken.balanceOf(lockBox.address)).to.equal(0);
      })

    })

    describe("Trade 1155 token for an NFT ", async () => {
    ...
    describe("Trade 1155 token for another 1155 token ", async () => {
      ...
      it("Both users can lock their assets ", async () => {
        ...
        await testERC1155.connect(user2).mint(11, 1);
        await testERC1155.connect(user2).setApprovalForAll(lockBox.address, true)
        await lockBox.connect(user2).lockAsset(1);
        ...
        expect(await testERC1155.balanceOf(user1.address, 11)).to.equal(0);
        expect(await testERC1155.balanceOf(user2.address, 11)).to.equal(0);
        expect(await testERC1155.balanceOf(lockBox.address, 11)).to.equal(1);
      ...
      it("Both users can claim their assets ", async () => {
        ...
        expect(await testERC1155.balanceOf(user1.address, 11)).to.equal(1);
        expect(await testERC1155.balanceOf(user2.address, 11)).to.equal(0);
        expect(await testERC1155.balanceOf(lockBox.address, 11)).to.equal(0);
      })
  ...
  describe("Trade ETHs", async () => {
    ...
    describe("Trade ETHs for an ERC1155 Token  ", async () => {
      ...
      it("Both users can claim their assets ", async () => {
        ...
        await expect(() =>
          lockBox.connect(user2).claimAsset(1)
        ).to.changeBalances([lockBox], [ethers.utils.parseEther("-1")])
